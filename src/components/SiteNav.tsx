    ...
    <header className="fixed top-0 inset-x-0 z-50 glass">
      <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm text-muted-foreground">
          ...
          <a href="/#skills" className="hover:text-primary transition story-link">
            Skills
          </a>
          <a href="/#projects" className="hover:text-primary transition story-link">
            Projects
          </a>
          <a href="/#timeline" className="hover:text-primary transition story-link">
            Journey
          </a>
          <a href="/#certificates" className="hover:text-primary transition story-link">
            Certificates
          </a>
